...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('/dashboard/asset/') }}" data-template="vertical-menu-template-free">
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">H-Commerce</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <a href="{{route('allproducts')}}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Authentications">Tất cả sản phẩm</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{route('pendingorder')}}" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Account Settings">Xử lý đơn hàng</div>
                        </a>
                    </li>
            ...
            <div class="layout-page">
                ...
                <script src="{{ asset('/dashboard/assets/vendor/libs/jquery/jquery.j') }}s"></script>
